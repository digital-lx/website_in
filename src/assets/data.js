import webimg from './images/web_development.svg'
import seo from './images/seo_optimization.svg'
import mobileapp from './images/mobile_development.svg';
import graphic from './images/GRAPHIC DESIGNER.jpg';
import content from './images/content_plan.png';
import marketing from './images/digital_marketing.svg'
...
export const services_data = [
    {
        ...
        features:{
            ...
            section_title:'Your Digital Storefront',
            body:'A website is the backbone of any business’ online presence. Our experienced developers understand that the digital habits of consumers are always changing, and our designs reflect the most up-to-date and creative approach to web design and development. Integrating shifting user habits with strong technology greatly improves the user experience. We design websites that engage and captivate audiences and develop websites to take advantage of the latest coding techniques to optimize search engine rankings.',
            image:webimg
          },
       packages:{
          basic:['Screens - 20 to 25', 'Content Upload', 'Responsive Design', 'Project Files Included','Icons','Images','Fonts','Lightning Fast VPS Hosting','Quarterly updates','Mobile/Web Testing Included (20 to 25 devices)','Company WebApp','Revisions - 3','Monthly Report',''],
          pro:['Basic Features +', 'Responsive Design Customization', 'Screens - 45 to 50', 'Licensed Images','Licensed Vectors','Licensed Fonts','Increase Organic Web Traffic','SEO Ready Content','SEO Ready Blog Content(2 * 1000 words post/month)','Social Media posts -5/week on 2 platforms','Conversion Optimization','Project Files Included','Bimonthly Updates','Professional Testing','Mobile/Web Testing Included(45 to 50 devices)','Professionaly Designed Company WebApp','Revisions - 5','Monthly Report',''],
          exclusive:['Standard Features +', 'Professional Design Customization', 'Increase Organic Web Traffic', 'Licensed Images','Licensed Vectors','Licensed Fonts','SEO Ready Blog Content(4 * 1000 words post/month','Google Ads Management','Social Media posts -5/week on 3 platforms','Segmentation Testing(70+ devices)','Professionaly Designed Company WebApp','Regular Updates']
        }
    },
    ...
    {    id:5,
        ...
        subtitle:'What catches the eye, captures the mind',
